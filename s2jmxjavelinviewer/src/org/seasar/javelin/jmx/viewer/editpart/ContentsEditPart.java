...
import org.seasar.javelin.jmx.viewer.editors.S2JmxJavelinXYLayoutEditPolicy;
...
public class ContentsEditPart extends AbstractGraphicalEditPart
{
	...
	{
	    installEditPolicy(EditPolicy.LAYOUT_ROLE, new S2JmxJavelinXYLayoutEditPolicy());
	}
