...
public class Invocation extends NotificationBroadcasterSupport 
	...
	public Invocation(ObjectName objName, ObjectName classObjName,
			String className, String methodName, int intervalMax,
	...
	public Invocation[] getAllCallerInvocation() 
	{
		Invocation[] invocations = (Invocation[]) callerSet_
				.toArray(new Invocation[callerSet_.size()]);
	...
	public void sendExceedThresholdAlarm() 
	{
		...
		AttributeChangeNotification notification = new AttributeChangeNotification(
				this, 0, System.currentTimeMillis(), ararmMsg, // アラームメッセージ
