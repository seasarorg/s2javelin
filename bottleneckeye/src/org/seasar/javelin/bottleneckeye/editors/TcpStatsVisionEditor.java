...
public class TcpStatsVisionEditor extends AbstractStatsVisionEditor<String> {
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#connect()
	 */
	public void connect() {
		try {
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#disconnect()
	 */
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#initializeGraphicalViewer()
	 */
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#start()
	 */
	public void start() {
		// 接続
		connect();
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#stop()
	 */
	public void stop() {
		// 接続
		disconnect();
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#doSaveAs()
	 */
	public void doSaveAs() {
	}

	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#isSaveAsAllowed()
	 */
	...
	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#setBlnReload(boolean)
	 */
	public void setBlnReload(boolean blnReload) {
	}

	/* (non-Javadoc)
	 * @see org.seasar.javelin.bottleneckeye.editors.StatsVisionEditor#reset()
	 */
	public void reset() {
        super.reset();
