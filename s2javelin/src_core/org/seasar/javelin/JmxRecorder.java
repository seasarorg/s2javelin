...
public class JmxRecorder {
	...
	public static void preProcess(String className, String methodName,
		...
		try {
			...
			name = ObjectNameUtil.createInvocationBeanName(className,
					methodName, config);
			ObjectName objName = new ObjectName(name);

			if (invocationBean == null) {
				String processName = VMStatusHelper.getProcessName();
				invocationBean = new Invocation(processName, objName,
	...
	private static void sendExceedThresholdAlarm(String jvnFileName,
		...
		if (invocation != null) {
			...
			jmxListener.sendExceedThresholdAlarm(jvnFileName, node);
		}
